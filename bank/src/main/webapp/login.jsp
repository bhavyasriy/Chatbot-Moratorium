  ...
  <body>
    ...
    <div class="container-login100">
      <div class="wrap-login100">
        ...
        <form action="login" method="post" onsubmit="return validate()" class="login100-form validate-form">
          <div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
            <span class="label-input100">Account number</span>
            <input class="input100" type="text" name="acc_no" id="username" required placeholder="Enter account number">
